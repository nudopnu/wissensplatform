...
import { Clock, Object3D, RepeatWrapping, Texture, TextureEventMap, TextureLoader, Timer } from "three";
...
@Component({
    selector: "grail",
    imports: [SceneComponent, SliderComponent, TextFieldComponent],
